...
const LANDING_COPY_DESIGNER = {
    ...
    'process.step1.body':
        'Share your photos, floor plans, and inspirations. <span class="lp-step__assurance">Free discovery call. Let\u2019s confirm we\u2019re a good fit.</span>',
    'process.step2.body':
    ...
    'whyUs.list':
        ...
        '<li><span class="lp-benefit-check" aria-hidden="true"></span><span class="lp-benefit-text"><span class="lp-lead__emphasis">We handle everything</span> &mdash; design, factory coordination, order tracking, and delivery</span></li>' +
